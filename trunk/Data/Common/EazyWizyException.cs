...
{
    public class EazyWizyException : ApplicationException
    {
        ...
        #endregion
        public EazyWizyException(string message, Exception innerException)
            : base(message, innerException)
        {
        }

        public EazyWizyException(string message)
            : base(message, null)
        {
        }
    }
    public class AuthenticationFailedException : EazyWizyException
    {
