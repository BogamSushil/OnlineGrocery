...
namespace EazyWizy.Domain.Entities
{
    ...
    public partial class EazyWizyEntities : DbContext
    {
        ...
        public virtual ObjectResult<SubMenu> sp_Select_GetSubMenuBrand()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SubMenu>("sp_Select_GetSubMenuBrand");
        }
    }
}
